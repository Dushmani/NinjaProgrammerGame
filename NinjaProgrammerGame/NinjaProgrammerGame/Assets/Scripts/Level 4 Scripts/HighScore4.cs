...
public class HighScore4 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        this.highScore4 = PlayerPrefs.GetInt("highScore4");
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetInt("highScore4", currentScore4);
        }
    }
    void OnGUI()
    {
        GUI.Label(new Rect(10, 30, 100, 20), "High Score: " + highScore4, largeFont);
    }
}
